...
describe("Dataset Upload Test", () => {
  ...
  it("Dataset Upload test", () => {
    ...
    cy.get(
      ":nth-child(2) > .left-navigation--sub-navi > :nth-child(1) > button.ng-tns-c0-0 > .ng-tns-c0-0"
    ).click();
    ...
    cy.get(
      ":nth-child(1) > .create-select-item__container > .create-select-item__content"
    ).click(); // Image 선택
    ...
    cy.get(
      ".cpu-gpu--selector > :nth-child(2) > div > .radio-item > em"
    ).click(); // 뉴럴 네트워크 CPU
    cy.get(
    ...
    cy.get("#graphContainerTrain > svg", { force: true })
      .should("exist")
      .as("svg");
    cy.wait(3000);
    ...
    //데이터셋에서 Resize 연결
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(1) > image"
    ).realHover("mouse");
    cy.wait(3000);
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(3) > :nth-child(3) > image"
    )
      .realMouseDown()
      .realMouseMove(200, 0)
      .realMouseUp();
    ...
    //Resize에서 VGG16 연결
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(3) > image"
    ).realHover("mouse");
    cy.wait(3000);
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(3) > :nth-child(3) > image"
    ...
    emailModule.email(
      ...
      Cypress.env("image_Project_Upload_emailbody")
    );
    ...
    cy.get(
      ":nth-child(2) > .create-select-item__container > .create-select-item__content"
    ).click(); // 레코드 선택
    ...
    cy.get(".NeuralNetwork").click();
    cy.get("form.ng-untouched > .search-box > .input-form").type(
      "DNN-Classification"
    );
    cy.get("form.ng-untouched > .search-box > .btn").click();
    cy.wait(3000);
    ...
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(5) > image"
    ).realHover("mouse");
    cy.wait(3000);
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(3) > :nth-child(3) > image"
    ...
    cy.get(
      ":nth-child(1) > .input-form > .ui-dropdown > .ui-dropdown-trigger > .ui-dropdown-trigger-icon"
    ).click(); // 열 선택
    cy.get(
      ":nth-child(1) > .ui-dropdown-item > div.ng-star-inserted > div"
    ).click(); // 상영시간 선택
    ...
    cy.get(
      ":nth-child(6) > .ui-dropdown-item > div.ng-star-inserted > div"
    ).click(); // 관객수
    cy.get(".combination-column-select > .btn").click(); // 추가
    ...
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(8) > image"
    ...
    cy.wait(3000);
    cy.get(
      ":nth-child(4) > .ui-multiselect-item > .ui-chkbox > .ui-chkbox-box > .ui-chkbox-icon"
    ...
    cy.get(
      "#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(10) > image"
    ...
    emailModule.email(
      ...
      Cypress.env("Record_Project_Create_emailbody")
    );
    ...
    cy.get(".btn-floating > div").click({ force: true }); // 생성
    cy.wait(3000);
    cy.get("input-form input-lg display-block ng-pristine ng-valid ng-touched")
      .clear()
      .type(Cypress.env("date_label"));
    cy.wait(1000);
    cy.get(".modal-button-content > .btn").click(); // 다음
    cy.wait(1000);
    ...
    // 인퍼런스 삭제
    cy.get(
      ".left-navigation--sub-navi > .current > button.ng-tns-c0-0 > .ng-tns-c0-0"
    ).click(); // 마이 인퍼런스
    cy.wait(5000);
    ...
    emailModule.email(
      ...
      Cypress.env("Record_Test_Project_Upload_emailbody")
    );
  });
});
