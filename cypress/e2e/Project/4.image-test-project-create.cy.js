...
describe("Image Test Project Create", () => {
  ...
  it("Image Test Project Create", () => {
    ...
    cy.wait(3000);
    cy.get(
      ":nth-child(2) > .create-select-item__container > .create-select-item__content > .create-select-item__title > .check-circle"
    ).click();
    ...
    cy.wait(3000);
    cy.contains("imageinferenceautomation 인퍼런스 서비스가 삭제되었습니다.");
  });
});
