const { loginModule, imageDatasetModule, recordDatasetModule, recordApiModule, sendEmailModule } = require('../module/manager.module.js');
...
describe('Dataset Upload Test', () => {
  ...
  it('Dataset Upload test', () => {
    ...
    cy.wait(5000);
        ...
        sendEmailModule.sendEmail(Cypress.env('Id'), 'Image Project Create Test ' + Cypress.env('EmailTitle'), ImageProjectCreateEmailBody);
    ...
    cy.wait(5000);
        ...
        sendEmailModule.sendEmail(Cypress.env('Id'), 'Image Test Project Create Test ' + Cypress.env('EmailTitle'), ImageTestProjectCreateEmailBody);
    ...
    cy.wait(5000);
        ...
        cy.get('#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(8) > image').click({
            force: true,
        }); // DNN-Classification 모델러 선택
        cy.wait(2000);
        ...
        cy.get('#graphContainerTrain > svg > :nth-child(1) > :nth-child(2) > :nth-child(10) > image').click({
            force: true,
        ...
        sendEmailModule.sendEmail(Cypress.env('Id'), 'Record Project Cteate Test ' + Cypress.env('EmailTitle'), RecordProjectCreateEmailBody);
